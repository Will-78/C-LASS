              ...
              <div className={`space-y-4 ${fullChatLog.length > 0 || generatingResponse ? "" : "flex flex-1 items-center justify-center"}`}>
                {fullChatLog.length === 0 && !generatingResponse ? (
                  ...
                  <>
                      ...
                      <div
                        ...
                        className={
                          message.role === "user"
                            ...
                            : "chat-assistant prose max-w-none rounded-3xl border border-transparent bg-transparent p-1 prose-headings:text-sky-950 prose-p:text-slate-700 prose-strong:text-sky-900 prose-a:text-sky-700"
                        }
                      >
                    ...
                    {generatingResponse && (
                      <div className="chat-assistant prose max-w-none rounded-3xl border border-transparent bg-transparent p-1 prose-headings:text-sky-950 prose-p:text-slate-700 prose-strong:text-sky-900 prose-a:text-sky-700">
          ...
          <footer className="shrink-0 px-4 py-3">
            ...
            <div className="chat-composer rounded-2xl border border-sky-200 bg-white/90 p-4 text-slate-800 shadow-lg shadow-sky-100">
              <textarea
                ...
                rows={3}
                className="max-h-40 w-full resize-y bg-transparent text-sm text-slate-400 placeholder:text-sky-500 focus:outline-none"
                onKeyDown={(e) => {
              ...
              />
              <div className="mt-2 flex items-center justify-between text-[11px] text-sky-700/80">
                <span>Model: GPT-4o</span>
                <button 
                  className="chat-send inline-flex items-center gap-1 rounded-full bg-sky-500 px-3 py-1 text-xs font-medium text-white transition hover:bg-sky-400 disabled:bg-sky-200 disabled:text-sky-500"
